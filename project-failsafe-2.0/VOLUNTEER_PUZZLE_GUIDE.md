...
- **Tournament Structure**:
  ...
  - **Round 2 (StratCom Arena - 16 Challenges)**:
...
| **R1** | **07** | Morse Audio Transmission | audio_log_07.mp3 | `WHITE` |
| **R1** | **08** | The Steganography Mask | Dark_Terminal.png | `SHADOW_CORE` |
| **R1** | **09** | Psychological Honeypot Trap | DO_NOT_RUN.exe | `CONTINUE` / `ACKNOWLEDGE` |
| **R1** | **10** | The Binary Master | CLEARANCE_CODE.txt | `ailnors` / `POLARIS` |
| **R1** | **11** | The Whiteout Signature | Whiteout_Signature.doc | `CLEARANCE_ALPHA` |
| **R1** | **12** | The ROT-4 IEEE Shift | ROT4_Shift.cipher | `ADITIS13` |
| **R1** | **13** | The Atbash Cipher Mirror | Mirror_Log.txt | `PROJECT` |
| **R1** | **14** | The Polybius Coordinate Trail | Matrix_Coordinates.pdf | `VECTOR` |
| **R1** | **15** | Frequency Override Count | Mass_System_Log.txt | `1400` |
| **R1** | **16** | Rogue Chatbot Polybius Shift | Intercepted_ADI_Transmission.pdf | `VSLXI` |
| **R1** | **17** | The Modular Clock Loop | Cycle_Diagnostics.png | `GCBGE` |
| **R1** | **18** | The Anomaly Checklist | Server_Status_Check.pdf | `GAMMA` |
| **R1** | **19** | The Shift Cipher Matrix | Emergency_Override_Key.txt | `DAHHK` |
| **R1** | **20** | The Log Anomaly Timeline (R1 Finale) | System_Audit_2013.log | `520` |
...
### STAGE 07: Morse Audio Transmission
...
### STAGE 09: Psychological Honeypot Trap
- **Evidence**: `DO_NOT_RUN.exe`
- **Mechanism**: Active AI honeypot trap. Opening or inspecting `DO_NOT_RUN.exe` automatically incurs an immediate **+5:00 (+300s) time penalty** on the mission timer. The bypass input box has been removed; teams advance by clicking the green **[⚡ ACKNOWLEDGE PENALTY & ADVANCE TO STAGE 10 →]** button or transmitting `CONTINUE`.
- **Key**: `CONTINUE` (Also accepts: `ACKNOWLEDGE`, `ADVANCE`, `BYPASS`, `DISARM`, `SKIP`, `OK`)

### STAGE 10: The Binary Master
...
### STAGE 16: The Rogue Chatbot Polybius Shift
...
### STAGE 17: The Modular Clock Loop
...
### STAGE 18: The Anomaly Checklist
...
### STAGE 19: The Shift Cipher Matrix
...
### STAGE 20: The Log Anomaly Timeline (Round 1 Finale)
