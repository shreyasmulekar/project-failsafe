...
function renderRound2Arena() {
    ...
    // ==========================================================================
      ...
      2: {
        ...
        taraSpeech: "Memory core located! In Dossier 02, click the glowing [▲ UP] and [▼ DN] buttons on each card to arrange timestamps from 4:17 PM to 10:15 PM, then click [⚡ RESTORE MEMORY SEQUENCE]!",
        taraWhereToClick: "1. Click Card 02 [ISHAAN Memory Core] in the Evidence Vault below.\n2. Click the glowing [▲ UP] and [▼ DN] arrow buttons next to each memory card to sort them chronologically (4:17 PM ➔ 10:15 PM).\n3. Click [⚡ RESTORE MEMORY SEQUENCE] below to restore the core!",
        taraModalGuide: "👉 WHERE TO CLICK: 1) Click the glowing [▲ UP] and [▼ DN] buttons next to each memory card to arrange them chronologically: 4:17 PM ➔ 6:45 PM ➔ 8:10 PM ➔ 9:32 PM ➔ 10:03 PM ➔ 10:15 PM. 2) Click the bright green [⚡ RESTORE MEMORY SEQUENCE] button below (or type 'decrypt 123456' in terminal)!",
